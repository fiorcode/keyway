...
class LetterColorAlphaPicker extends StatefulWidget {
  LetterColorAlphaPicker(this.color, this.change);

  final Function change;
  final Color color;

  @override
  _LetterColorAlphaPickerState createState() => _LetterColorAlphaPickerState();
}
