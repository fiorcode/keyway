...
class LetterBlueColorPicker extends StatefulWidget {
  LetterBlueColorPicker(this.color, this.change);

  final Function change;
  final Color color;

  @override
  _LetterBlueColorPickerState createState() => _LetterBlueColorPickerState();
}

class _LetterBlueColorPickerState extends State<LetterBlueColorPicker> {
  double? _value;
  Color? _color;
