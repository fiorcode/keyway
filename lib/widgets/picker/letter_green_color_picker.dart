...
class LetterGreenColorPicker extends StatefulWidget {
  LetterGreenColorPicker(this.color, this.change);

  final Function change;
  final Color color;

  @override
  _LetterGreenColorPickerState createState() => _LetterGreenColorPickerState();
}

class _LetterGreenColorPickerState extends State<LetterGreenColorPicker> {
  double? _value;
  Color? _color;
